...
def store_categories(request):
    ...
    return render(request,'manager/store-category.html',context=context)
...
def store_categories_add(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, "manager/add-store-category.html", context=context)
...
def store_managers(request):
    managers = Manager.objects.all()

    context = {
        'title': "Store Managers | Dashboard",
        'sub_title': "Store Manager Management",
        'name': "Store Manager List",
        'managers': managers,
    }

    return render(request, 'manager/store_manger.html', context=context)
...
def food_category(request):
    ...
    return render(request, 'manager/food-category.html', context=context)
...
def add_foodcategory(request):
    ...
    return render(request, 'manager/add-food-category.html', context=context)
...
def fooditem(request):
    ...
    return render(request,'manager/fooditem.html',context=context)
...
def add_fooditem(request):
    ...
    if request.method == 'POST':
        if form.is_valid():
            form.save()
            return HttpResponseRedirect(reverse('manager:fooditem'))
        else:
            form = FoodItemForm()
...
def currentOrder(request,id):
    ...
    return render(request, 'manager/currentOrder.html',context=context)
